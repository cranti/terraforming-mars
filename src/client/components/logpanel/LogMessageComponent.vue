<template>
   <li v-if="message !== undefined && message.data !== undefined && message.message !== undefined" v-on:click.prevent="$emit('click')" :class="{'log-steal': isStealMessage}">
...
export default defineComponent({
  ...
  computed: {
    ...
    isStealMessage(): boolean {
      return this.message?.message?.includes('stole') ?? false;
    },
